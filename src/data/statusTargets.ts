  ...
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        evidence: '`npm.cmd run playlab:synthetic` 会检查公开入口、游戏列表、First Tetris 详情页、公开试玩 index 和从 HTML 发现的 Godot Web 资源响应；缺少新发布批准时不会把未验证构建包装成已上线。',
        cadence: '游戏导出后',
      ...
      },
      {
        ...
        evidence: '`playlab:synthetic` 会从公开 Playlab 页面中检查移动、触屏、触控、多端和键盘等低风险提示文案。',
        cadence: 'UI 改动后',
