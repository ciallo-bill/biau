...
Branch: main
Controller: Codex
Builder: Claude Code + Codex fallback

## Goal

Add real runtime screenshots for InteSpace and connect them to the public showcase site.

## Scope

- Use the complete Windows source project only through a temporary capture copy.
- Publish reviewed, public-safe runtime screenshots for the player hub and gameplay HUD; add a result/flow screenshot only if it can be captured reliably.
- Use a real runtime screenshot as the InteSpace project visual.
- Add InteSpace runtime evidence to /cases/godot-showcase.
...
- Do not claim Raiden has real runtime screenshots yet.

## Allowed Paths

- public/images/projects/showcase/intespace-*.png
...
- [x] InteSpace screenshots are generated from the actual Godot project in a temporary copy.
- [x] Selected screenshots are public-safe and added to public/images/projects/showcase.
- [x] InteSpace project card/detail uses a real runtime screenshot.
- [x] /cases/godot-showcase includes InteSpace runtime evidence alongside the existing structure diagram.
